class Customer < ApplicationRecord
  ...
  validates :dl_image, :presence => true
  validates :cust_f_name, :cust_l_name, :cust_address, :cust_city, :cust_email, :dl_number, :dob, :state_province_id, :country_id, :customer_status_id, :customer_type_id, :presence => true
